...
@section('left-menu')
    <div class="accordion" id="accordionUsers">
        <div class="card nsc-card-left-menu">
            <div class="card-header nsc-head-left-menu" id="headingUsers">
                <h5 class="mb-0">
    ...
    <div class="accordion" id="accordionRoles">
        <div class="card nsc-card-left-menu">
            <div class="card-header nsc-head-left-menu" id="headingRoles">
                <h5 class="mb-0">
            ...
            <div id="collapseRoles" class="collapse" aria-labelledby="headingRoles" data-parent="#accordionRoles">
                <div class="card-body">
    ...
    <div class="accordion" id="accordionPaths">
        <div class="card nsc-card-left-menu">
            <div class="card-header nsc-head-left-menu" id="headingPermissions">
                <h5 class="mb-0">
            ...
            <div id="collapsePaths" class="collapse" aria-labelledby="headingPermissions" data-parent="#accordionPaths">
                <div class="card-body">
